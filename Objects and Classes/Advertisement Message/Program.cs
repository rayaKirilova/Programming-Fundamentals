...
namespace Advertisement_Message
{
    class Program
    {
        ...
        {
            int countNumberOfMessages = int.Parse(Console.ReadLine());
            ...
            for (int i = 0; i < countNumberOfMessages; i++)
            {
                string phras = phrases[rand.Next(0, phrases.Length)];
                ...
                Console.WriteLine("{0} {1} {2} - {3}", phras, eventa, author, city);
            }
        }
    }
}
